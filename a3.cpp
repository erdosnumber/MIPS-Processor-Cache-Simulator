...
int main (int argc, char *argv[]) {
    ...
    // L2_Size = 65536;
    // L2_Assoc = 8;
    // string filename = "memory_trace_files/trace8.txt";
    ...
    cout << "v. L1 miss rate : " << fixed << setprecision(4) << double(L1ReadMiss + L1WriteMiss)/(L1Reads + L1Writes) << '\n';
    ...
    cout << "xi. L2 miss rate : " << fixed << setprecision(4) << double(L2ReadMiss + L2WriteMiss)/(L2Reads + L2Writes) << '\n';
